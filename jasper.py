...
parser = argparse.ArgumentParser(description='Samantha Voice Control Center')
...
class Jasper(object):
    ...
    def run(self):
        ...
        conversation = Conversation("SAMANTHA", self.mic, self.config)
        conversation.handleForever()

if __name__ == "__main__":

    print("*******************************************************")
    print("*             SAMANTHA - THE TALKING COMPUTER         *")
    print("*              (c) 2015 - 2017 Brayden Moon           *")
    print("*******************************************************")
    ...
    if not args.no_network_check and not diagnose.check_network_connection():
        logger.warning("Network not connected. This may prevent Samantha from " +
                       "running properly.")
